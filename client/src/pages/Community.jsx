               ...
               <div className='flex flex-wrap max-sm:justify-center gap-5'>
                  {
                     images.map((item, index) => (
                        <a className='relative group block rounded-lg overflow-hidden border border-gray-200 dark:border-purple-700 shadow-sm hover:shadow-md transition-shadow duration-300' href={item.imageUrl} target='_blank' key={index}>
