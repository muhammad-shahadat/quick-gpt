...
const Sidebar = ({ isMenuOpen, setIsMenuOpen }) => {
    ...
    return (
        ...
        <>
            ...
            {/*menu icon*/}
            <div className='absolute top-3 left-3 w-8 h-8 cursor-pointer md:hidden not-dark:invert'>
                {!isMenuOpen && <img onClick={() => { setIsMenuOpen(!isMenuOpen) }} src={assets.menu_icon} />}
            </div>
                        ...
                        <div className="space-y-1">
                            {filteredChats.map((chat) => (
                                <div
                                    ...
                                    className={`group flex items-center justify-between p-3 rounded-lg cursor-pointer transition-all ${currentChatId === chat._id ? "bg-blue-500/10 text-blue-600 dark:bg-blue-500/20" : "hover:bg-gray-200 dark:hover:bg-white/5"
                                        }`}
                                >
